        ...
        <div>
            <form class="form-horizontal" role="form" method="POST" action="{{ url('admin/article_cat/save') }}">
                ...
                <div class="form-group">
                    <label class="col-md-2 control-label" for="cat_name">{{trans('article.cat.name')}}</label>
                    <div class="col-md-4"><input type="text" class="form-control input-sm" name="cat_name" id="cat_name" value="{{$cat->cat_name}}"></div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 control-label" for="parent_id">{{trans('article.cat.parent')}}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group">
                    <label class="col-md-2 control-label" for="show_in_nav">{{trans('article.cat.show_in_nav')}}</label>
                ...
                <div class="form-group">
                    <label class="col-md-2 control-label" for="cat_desc">{{trans('article.cat.desc')}}</label>
